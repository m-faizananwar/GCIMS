...
// Dynamically import ClickableMap to prevent SSR issues with leaflet
const ClickableMap = dynamic(
  () => import('@/app/components/general/map/map').then(mod => ({ default: mod.ClickableMap })),
  { ssr: false }
) as any

export const EditCarClient = () => {
